...
export function StatsPanel() {
  ...
  return (
    <div className="w-full bg-black/80 backdrop-blur-md rounded-2xl shadow-2xl overflow-hidden border border-gray-800/50">
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div className="p-4 bg-gray-900/60 rounded-xl border border-gray-800">
            ...
            <p className="mt-2 text-xl font-bold text-white">{stats?.network_utilization_percentage.toFixed(1)}%</p>
          </div>
